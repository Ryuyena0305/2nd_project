...
insert into movieReview(reviewTitle, reviewContent, reviewRating,reviewDate,memberId,movieId) values('정말재밌어요!', '배우들 연기도 좋고 스토리가 탄탄해서 정말 재미있었어요', 5,'2025-01-01',4,1);
