...
public class AdminPrintUserDao extends Dao{
	...
	public ArrayList<AdminPrintUserDto> printUser() {
		...
		String sql = "SELECT member.mname,resv.resvId,member.memberId,member.mId,movie.movieName,timeTable.movieDate,theater.theaterId,resvSeat.seatNum,resv.resvDate "
